...
func InitOptionMap() {
	...
	common.OptionMap["OpenAliceManagedGroups"] = setting.OpenAliceManagedGroups2JSONString()
	common.OptionMap["OpenAliceRoutableGroups"] = setting.OpenAliceRoutableGroups2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "OpenAliceManagedGroups":
		err = setting.UpdateOpenAliceManagedGroupsByJSONString(value)
	case "OpenAliceRoutableGroups":
		err = setting.UpdateOpenAliceRoutableGroupsByJSONString(value)
	case "RetryTimes":
